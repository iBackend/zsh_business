...
<div style="position:absolute;top:88px;left:188px;width:100%;">
	<div class="place" style="height:36px;">
	    <span>位置：</span>
	    <ul class="placeul">
	    <li><a href="javascript:;">先赔管理列表</a></li>
	    </ul>
	    </div>
	    	...
	    	<table class="m-table">
	    	    ...
	    	    <tbody>
	    	        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
	    	        		...
	    	        		<!-- <td>
	    	        			<a href="/index.php?m=Integritygold&a=do_compen&id=<?php echo ($vo["id"]); ?>" class="u-btn u-btn-c2">先赔</a>
	    	        			<a href="/index.php?m=Integritygold&a=refused_compen&id=<?php echo ($vo["id"]); ?>" class="u-btn u-btn-c1">拒绝</a>
	    	        		</td> -->
