...
<div style="position:absolute;top:88px;left:188px;width:100%;">
	<div class="place" style="height:36px;">
	    ...
	    <div class="mainindex"  style="width:80%;position:relative;left:-100px;">
	    	...
	    	<a href="/index.php?m=Goodmanage&a=addcategory" class="u-btn u-btn-c3">增加类目</a>
	    	<br><br>
	    	<table class="m-table">
	    	    <thead>
	    	        <tr>
	    	    ...
	    	    <tbody>
	    	        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><tr>
	    	        		...
	    	        		<td>
	    	        			<a href="/index.php?m=Goodmanage&a=dcategory&id=<?php echo ($vo["id"]); ?>" class="u-btn u-btn-c1">删除</a>
	    	        			<!-- <a href="">编辑</a> -->
	    	        		</td>
